...
//        Ref.child(apartmentRandomKey).push().setValue(new Houses(apartmentRandomKey,downLoadImageUrl,apartmentDescription.getText().toString(),apartmentPlace.getText()
